...
export default function RequestDetailPage() {
  ...
  useEffect(() => {
    ...
    const timeoutId = window.setTimeout(() => {
      ...
      getRequest(params.id).then((loadedRequest) => {
